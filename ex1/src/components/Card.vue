...
<template>
    ...
    <div class="flex items-center justify-center h-screen bg-zinc-700">
        ...
        <div class="bg-zinc-800 p-2 mx-1 rounded-2xl">
            <!-- Flex -->
            <div class="flex flex-col md:flex-row rounded-1-xl">
                <!-- Img -->
                <img
                    src="../assets/pic.jpg"
                    alt=""
                    class="object-fit rounded-xl h-80 md:h-64 md:rounded-1-xl md:rounded-r-none transform hover:scale-105 hover:rounded-xl duration-200"
                />
                <!-- Content -->
                <div class="text-white p-6 md:p-12">
                    <h2
                        class="font-serif text-xl font-medium text-center md:text-left"
                    >
